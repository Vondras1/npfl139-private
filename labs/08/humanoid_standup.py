...
parser.add_argument("--model_path", default="humanoid_standup_models/humanoid", type=str, help="Model path")
parser.add_argument("--load_model_path", default="humanoid_standup_models/humanoid_0", type=str, help="Model path of pretrained model we want to load.")
