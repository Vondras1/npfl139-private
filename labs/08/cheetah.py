...
parser.add_argument("--model_path", default="cheetah_models/cheetah", type=str, help="Model path")
parser.add_argument("--load_model_path", default="cheetah_models/cheetah_5652", type=str, help="Model path of pretrained model we want to load.")
