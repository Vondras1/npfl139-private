...
parser.add_argument("--model_path", default="pisqorky_heuristic_v2.pt", type=str, help="Model path")
parser.add_argument("--num_simulations", default=0, type=int, help="Number of simulations in one MCTS.") # 1024
